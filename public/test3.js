(function () {
  ...
  myConnector.getSchema = function (schemaCallback) {
    var physicalDataCols = [
      ...
      { id: "player_id", dataType: tableau.dataTypeEnum.string },
      { id: "player_birthdate", dataType: tableau.dataTypeEnum.date },
      { id: "team_name", dataType: tableau.dataTypeEnum.string },
      { id: "team_id", dataType: tableau.dataTypeEnum.string },
      { id: "match_name", dataType: tableau.dataTypeEnum.string },
      { id: "match_id", dataType: tableau.dataTypeEnum.string },
      { id: "match_date", dataType: tableau.dataTypeEnum.date },
      { id: "competition_name", dataType: tableau.dataTypeEnum.string },
      { id: "competition_id", dataType: tableau.dataTypeEnum.string },
      { id: "season_name", dataType: tableau.dataTypeEnum.string },
      { id: "season_id", dataType: tableau.dataTypeEnum.string },
      { id: "competition_edition_id", dataType: tableau.dataTypeEnum.string },
  ...
  function fetchCompetitionEditionsData(table, token, doneCallback) {
    var apiUrl =
      "https://skillcorner.com/api/competition_editions/?token=" + token;

    console.log("Competition Editions Data API URL:", apiUrl);
