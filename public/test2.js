(function () {
  ...
  myConnector.getData = function (table, doneCallback) {
    ...
    if (table.tableInfo.id === "physicalData") {
      fetchPhysicalData(table, parameterValues, doneCallback);
    }
  ...
  function fetchPhysicalData(table, parameterValues, doneCallback) {
    ...
    function fetchData(url, pageCount) {
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          var username = tableau.username; // Provided by Tableau
          var password = tableau.password; // Provided by Tableau
